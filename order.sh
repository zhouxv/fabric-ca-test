...
export FABRIC_CA_SERVER_HOME=$HOME/fabric-ca-test/test/org0-ca/crypto
...
export FABRIC_CA_CLIENT_HOME=$HOME/fabric-ca-test/test/org0-ca-admin/crypto
...
# org0 orderer
export FABRIC_CA_CLIENT_HOME=$HOME/fabric-ca-test/test/org0/orderer
export FABRIC_CA_CLIENT_DEBUG=true
...
# org0 admin
export FABRIC_CA_CLIENT_HOME=$HOME/fabric-ca-test/test/org0/admin
export FABRIC_CA_CLIENT_DEBUG=true
export FABRIC_CA_CLIENT_MSPDIR=msp
export FABRIC_CA_CLIENT_BCCSP_SW_HASH=SHA2
export FABRIC_CA_CLIENT_BCCSP_SW_SECURITY=384
...
sudo mkdir $HOME/fabric-ca-test/test/org0/orderer/msp/admincerts
sudo cp $HOME/fabric-ca-test/test/org0/admin/msp/signcerts/cert.pem $HOME/fabric-ca-test/test/org0/orderer/msp/admincerts