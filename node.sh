...
configtxgen -profile TwoOrgsOrdererGenesis -outputBlock /home/dinglab-dell/fabric-ca-test/nodeconfig/org0_order/genesis.block -channelID syschannel
configtxgen -profile OrgsChannel -outputCreateChannelTx $HOME/fabric-ca-test/nodeconfig/org0_order/channel.tx -channelID mychannel
