...
# org1 peer1
export FABRIC_CA_CLIENT_HOME=$HOME/fabric-ca-test/test/org1/peer1
export FABRIC_CA_CLIENT_DEBUG=true
...
# org1 peer2
export FABRIC_CA_CLIENT_HOME=$HOME/fabric-ca-test/test/org1/peer2
export FABRIC_CA_CLIENT_DEBUG=true
export FABRIC_CA_CLIENT_MSPDIR=msp
export FABRIC_CA_CLIENT_BCCSP_SW_HASH=SHA2
export FABRIC_CA_CLIENT_BCCSP_SW_SECURITY=384
...
# org1 admin
export FABRIC_CA_CLIENT_HOME=$HOME/fabric-ca-test/test/org1/admin
export FABRIC_CA_CLIENT_DEBUG=true
export FABRIC_CA_CLIENT_MSPDIR=msp
export FABRIC_CA_CLIENT_BCCSP_SW_HASH=SHA2
export FABRIC_CA_CLIENT_BCCSP_SW_SECURITY=384
...
sudo mkdir $HOME/fabric-ca-test/test/org1/peer1/msp/admincerts
sudo mkdir $HOME/fabric-ca-test/test/org1/peer2/msp/admincerts
sudo cp $HOME/fabric-ca-test/test/org1/admin/msp/signcerts/cert.pem $HOME/fabric-ca-test/test/org1/peer1/msp/admincerts
sudo cp $HOME/fabric-ca-test/test/org1/admin/msp/signcerts/cert.pem $HOME/fabric-ca-test/test/org1/peer2/msp/admincerts